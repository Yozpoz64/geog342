...
Table 1 gives example scores for the factors of the index. Here you can see that lower scores describe poor conditions, while higher scores describe good conditions. This is consistent across all factors so that they can be combined easily. 
